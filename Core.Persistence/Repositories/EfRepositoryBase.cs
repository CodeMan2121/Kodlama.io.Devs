...
{
    internal class EfRepositoryBase<TEntity, TContext> : IAsyncRepository<TEntity>, IRepository<TEntity>
        ...
        where TContext : DbContext
    {
        ...
        public IPaginate<TEntity> GetListByDynamicQuery(Dynamic.Dynamic dynamic,
                                                   Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>?
